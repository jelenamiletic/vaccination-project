...
public class RDFDBAuthenticationUtilities {
	...
	static public class ConnectionProperties {
		...
		public ConnectionProperties(Properties props) {
			super();
			dataset = props.getProperty("fuseki.dataset").trim();
			endpoint = props.getProperty("fuseki.endpoint").trim();
			
			queryEndpoint = String.join("/", endpoint, dataset, props.getProperty("fuseki.query").trim());
			updateEndpoint = String.join("/", endpoint, dataset, props.getProperty("fuseki.update").trim());
			dataEndpoint = String.join("/", endpoint, dataset, props.getProperty("fuseki.data").trim());
