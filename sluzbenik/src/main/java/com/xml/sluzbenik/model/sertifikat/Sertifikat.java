...
import com.xml.sluzbenik.model.RezultatTesta;
...
public class Sertifikat {
    ...
    public static class LicneInformacije {
        ...
        @XmlElement(required = true)
        protected com.xml.sluzbenik.model.PunoIme PunoIme;

        @XmlElement(required = true)
        protected XMLGregorianCalendar DatumRodjenja;

        @XmlElement(required = true)
        protected com.xml.sluzbenik.model.Pol Pol;
    ...
    public static class Vakcinacija {
        ...
        public com.xml.sluzbenik.model.Proizvodjac getTipVakcine() {
            return TipVakcine;
        }

        public void setTipVakcine(com.xml.sluzbenik.model.Proizvodjac tipVakcine) {
